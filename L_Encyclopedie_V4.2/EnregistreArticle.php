...
//
$Idarticle=$_POST['Idarticle'];// On récupére l'Idarticle
...
/* 
$UPDATE = $bdd->prepare('UPDATE article SET TITRE = :TITRE WHERE Idarticle = :Idarticle') ;
$UPDATE->execute(array( 'TITRE' => $TITRE ) );

 */

$_SESSION['validation']="Correction _ ' $TITRE '" ;

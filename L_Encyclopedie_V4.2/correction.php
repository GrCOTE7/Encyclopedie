...
<form method="POST" action="EnregistreArticle.php"  enctype="multipart/form-data">

Idarticle = <input type="text" name="Idarticle"  value="<?php echo $resultat['Idarticle'] ; ?> " class="hidden" /> <hr>

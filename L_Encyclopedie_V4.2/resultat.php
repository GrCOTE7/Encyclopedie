...
//
?>
<form method="Get" action="correction.php">

	<input type="text" name="Idarticle" value="<?php echo $resultat['Idarticle'] ?>" class="hidden" >
	<input type="submit" value="correction" class="envoyer" >
